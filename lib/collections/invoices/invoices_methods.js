  ...
  ciuExport: function(invoice) {
    ...
    */
    ...
    function prependZeros(maxLen, num, recordName) {
      ...
      // #2 Vendor Number
      var hdr2 = prependZeros(10, vendorNumber);

      // #3 Invoice Number
      var hdr3 = appendSpaces(25, invoiceNumber);
      ...
      // point!
      // TODO: need a function here, or something like:
      var hdr7 = prependZeros(11, invoiceAmount);

      // #8 Transaction Code
      var hdr8 = prependZeros(3,'110');
      ...
      var hdr14 = appendSpaces(200, headerDescription);
      ...
      var ciuFile = exportDir + interfaceNumber + fileNameDate + '.dat1';
      ...
      for (k = 0; k < invoiceLines.length; k++) {
        ...
        // Retail amount
        var ddr14 = prependZeros(11,'');

        // Quantity invoiced sign
        var ddr15 = checkInvoiceSign();

        // Invoiced Quantity
        var ddr16 = prependZeros(11, quantity.toString());

        // Unit Cost
        var ddr17 = prependZeros(11, unitCost*100);

        // Line Description
        var ddr18 = appendSpaces('200', lineDescription);

        // Last Ship Date
        var ddr19 = prependZeros(8,'');

        // PO#
        var ddr20 = appendSpaces(20, '');

        // PO Cost sign
        var ddr21 = checkInvoiceSign();

        // PO Cost
        var ddr22 = prependZeros(11,'');

        // Received Quantity sign
        var ddr23 = checkInvoiceSign();

        // Received Quantity
        var ddr24 = prependZeros(11,'');

        // Start Ship Date
        var ddr25 = prependZeros('8','');

        // Store
        var ddr26 = prependZeros('4','');

        // SKU
        var ddr27 = prependZeros('8','');

        // Style
        var ddr28 = prependZeros('20','');

        // Class
        var ddr29 = prependZeros('4','');

        // Docrec
        var ddr30 = prependZeros(7,'');

        // Ship Date
        var ddr31 = prependZeros('8','');

        // Cancel Date
        var ddr32 = prependZeros('8','');
