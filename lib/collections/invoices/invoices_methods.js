...
Meteor.methods({
  ciuExport: function(invoice) {
    ...
    var hdr15 = appendSpaces(8, '');

    // #16 URN Number
    var hdr16 = appendSpaces(10, urn);

    // #17 Department Number
    var hdr17 = appendSpaces(4, department);

    // #18 Manufacturer Number
    var hdr18 = appendSpaces(4, manufacturer);
    ...
    for (k = 0; k < invoiceLines.length; k++) {
      ...
      var lineRetailCost = invoiceLines[k].lineRetailCost;
      ...
      var ddr5 = prependZeros(11, ensurePositive(lineTotal)*100);
      ...
      // Retail amount
      var ddr14 = prependZeros(11, ensurePositive(lineRetailCost)*100,'Retail amount');
      ...
      var ddr17 = prependZeros(11, unitCost, 'unit cost');
