// Code to active Flakes JS and CSS for Nav elements. Flakes works fine until you add Iron Router,
// then it seems to stop activating CSS classes, and some JS functions:
